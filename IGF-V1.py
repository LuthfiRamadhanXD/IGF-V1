...
sys.stdout.write('\x1b]2; LUTHFI XD. PRIVATE\x07')
...
if luciverganteng_banget in ['1']:
	os.system("xdg-open https://wa.me/+6282267229931?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Day+20K")
elif luthfiganteng_banget in ['2']:
	os.system("xdg-open https://wa.me/+6282267229931?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+2+Day+40")
elif luthfiganteng_banget in ['3']:
	os.system("xdg-open https://wa.me/+6282267229931?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+7+Day+50K+yang+diskon")
elif luthfiganteng_banget in ['4']:
	os.system("xdg-open https://wa.me/+6282267229931?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+1+Bulan+100K")
elif luthfiganteng_banget in ['5']:
	os.system("xdg-open https://wa.me/+6282267229931?text=Assalamualaikum+bang+gua+mau+beli+Lisensi+open+source+200K")
elif luthfiganteng_banget in ['0']:
	exit()
loading()
os.system('clear')
banner()	
Password = "bangluthfi"  #--> Data Req Api key --> open_kt(life)("https://github.com/loser-401/loser/blob/main/paid.txt")
